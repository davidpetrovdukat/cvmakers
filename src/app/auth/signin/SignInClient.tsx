...
const COPY = {
  ...
  ja: {
    ...
    login: 'ログイン',
    signupIntro: 'アカウントを作成して始めましょう。',
    loginIntro: 'おかえりなさい。ログインしてください。',
    fillRequired: '必須項目をすべて入力してください',
    registrationFailed: '登録に失敗しました',
    invalidLogin: 'メールアドレスまたはパスワードが無効です',
    email: 'メールアドレス',
    password: 'パスワード',
    firstName: '名',
    lastName: '姓',
    dateOfBirth: '生年月日',
    street: '住所',
    streetPlaceholder: '番地・建物名',
    city: '市区町村',
    cityPlaceholder: '市区町村名',
    country: '国',
    selectCountry: '国を選択',
    postalCode: '郵便番号',
    postalPlaceholder: '例：100-0001',
    termsPrefix: '以下を読み、同意します：',
    terms: '利用規約',
    creating: '作成中です...',
    signingIn: 'ログイン中です...',
    create: 'アカウントを作成',
